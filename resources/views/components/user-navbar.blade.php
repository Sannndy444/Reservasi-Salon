            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a href="{{ route('user.services.index') }}"
                        class="nav-link text-dark poppins-semibold">Services</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('user.stylists.index') }}"
                        class="nav-link text-dark poppins-semibold">Employee</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('user.appointment.index') }}"
                        class="nav-link text-dark poppins-semibold">Appointment</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('user.suggestions.index') }}"
                        class="nav-link text-dark poppins-semibold">Suggestions</a>
                </li>
            </ul>
        </div>
                ...
                <ul class="dropdown-menu">
                    <li>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: flex;"
                            onsubmit="return confirm('Are you sure to Log out?')">
                            @csrf
                        </form>
