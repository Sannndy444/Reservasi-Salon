            ...
            <div class="navbar-brand text-dark mb-0 h1 font-md poppins-extrabold-italic">Admin Panel</div>
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.stylists.index') }}" class="nav-link text-dark poppins-semibold">Employee</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.reviews.index') }}" class="nav-link text-dark poppins-semibold">Reviews</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.suggestions.index') }}" class="nav-link text-dark poppins-semibold">Suggestions</a>
                        </li>
                        <li class="nav-item">
