            ...
            <div class="navbar-brand text-dark mb-0 h1 font-md poppins-extrabold-italic">Sisir Emosi</div>
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark poppins-semibold">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark poppins-semibold">Services</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark poppins-semibold">Stylists</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark poppins-semibold">Appointment</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark poppins-semibold">Suggestions</a>
                        </li>
                    </ul>
                </div>
